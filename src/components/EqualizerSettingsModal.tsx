    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/40 backdrop-blur-sm" id="eq-modal-backdrop">
        ...
        <motion.div
          ...
          className="relative w-full max-w-md h-[60vh] bg-white/95 text-brand-dark rounded-t-[40px] px-6 pt-5 pb-6 shadow-2xl border-t border-white/60 backdrop-blur-xl z-50 flex flex-col gap-4 select-none"
          id="eq-modal-panel"
        >
          {/* Top Decorative drag handle pill */}
          <div className="w-12 h-1 bg-brand-medium/20 rounded-full mx-auto mb-1 flex-shrink-0" />
          ...
          {/* Scrollable contents */}
          <div className="flex-1 overflow-y-auto pr-1 flex flex-col gap-5 scrollbar-thin scrollbar-thumb-brand-primary/20" id="eq-modal-scrollable-content">
            {/* Equalizer Spectrum Curve Card */}
            <div className="relative h-28 shrink-0 bg-stone-900 rounded-2xl overflow-hidden border border-stone-800 shadow-inner flex flex-col justify-end p-2">
            ...
            <div className="flex justify-between items-stretch gap-2 bg-white/50 border border-brand-secondary/20 p-4 rounded-3xl shadow-sm h-52 shrink-0">
            ...
            <div className="flex items-center justify-between bg-brand-primary/5 border border-brand-primary/10 rounded-2xl p-3 shrink-0">
              <div className="flex items-center gap-2">
